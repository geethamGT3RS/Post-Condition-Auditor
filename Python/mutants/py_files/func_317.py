...
def _mutmut_trampoline(orig, mutants, call_args, call_kwargs, self_arg = None):
    ...
    return result
def x_merge__mutmut_orig(lst):  
    return [list(ele) for ele in list(zip(*lst))] 
def x_merge__mutmut_1(lst):  
    return [list(None) for ele in list(zip(*lst))] 
def x_merge__mutmut_2(lst):  
    return [list(ele) for ele in list(None)] 
