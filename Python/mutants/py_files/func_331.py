...
def _mutmut_trampoline(orig, mutants, call_args, call_kwargs, self_arg = None):
  ...
  return result
def x_replace_spaces__mutmut_orig(string):
  return string.replace(" ", "%20")
def x_replace_spaces__mutmut_1(string):
  return string.replace(None, "%20")
def x_replace_spaces__mutmut_2(string):
  return string.replace(" ", None)
def x_replace_spaces__mutmut_3(string):
  return string.replace("%20")
def x_replace_spaces__mutmut_4(string):
  return string.replace(" ", )
def x_replace_spaces__mutmut_5(string):
  return string.replace("XX XX", "%20")
def x_replace_spaces__mutmut_6(string):
  return string.replace(" ", "XX%20XX")
